...
<div class="col-md-2">
<a href="?module=transaksi/view" class="btn btn-info btn-sm"> <span class=" fas fa-reply"></span> Kembali</a>
</div>
<p align="center">UD. DWI PUTRA</p>
<center>Detail Pesanan Bibit Sawit</center>
...
<br /><br />  Pasaman Barat, <?php echo date('d').' '.(strtolower($bulan[date('m')])).' '.date('Y') ?></td>
  </tr>
  <tr>
