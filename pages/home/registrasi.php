...
Dalam kehidupan, akan ada hal yang datang dengan sendirinya. Namun akan ada hal juga yang perlu perjuangan untuk mendapatkannya.</p>
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>Isi Registrasi Dengan Benar</h2>
                        ...
                        <form method="POST" action="../controller/HomeController.php?aksi=registrasi">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="name" name="nama" placeholder="Masukan nama lengkap" required data-error="Please enter your name">
                                        <div class="help-block with-errors"></div>
                                    </div>
                              
                                    <div class="form-group">
                                        <label for="">Email</label>
                                        <input type="email" placeholder="Masukan Email" id="email" class="form-control" name="email" required data-error="Please enter your email">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="submit-button text-center">
                                        <button class="btn hvr-hover" id="submit" type="submit">Registrasi</button>
