            ...
            <?php  foreach($db->produk_detail($_POST['id_produk']) as $detail): ?>
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-item active"> <img class="d-block w-100" src="../images/produk/<?= $detail->gambar_produk ?>" alt="First slide"> </div>
                    ...
                    <div class="single-product-details">
                        ...
                        <!-- <h5> <del>$ 60.00</del>Rp.</h5> -->
                                ...
                                <div class="price-box-bar">
                                    ...
                                    <form method="POST" action="?page=member/keranjang">
                                   <input  type="hidden" name="id_produk" value="<?= $p->produk_id?>">
                                   <a href="#!" class="cart" >
                                    <button style="color:white" type="submit" data-fancybox-close="" class="btn hvr-hover" name="beli"><span class="fa fa-check"> </span> Beli Sekarang</button></a>

                                    <a href="#!" class="cart" >
                                    <button style="color:white" type="submit" data-fancybox-close="" class="btn hvr-hover" name="add_cart"><span class="fab fa-opencart"></span> Masukan Keranjang</button>  
                                </form>
                        ...
                        <div class="item" style="margin-left:10px;">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                   ...
                                   <input type="hidden" name="id_produk" value="<?= $p->produk_id?>">
                                <a href="#!" class="cart" >
                                    <button type="submit" class="btn-sm" style="background-color:#d33b33; color:#fff" name="add"> Add To Cart</button>                             
                                </a>
                                </form>
                                    </div>
                                </div>
